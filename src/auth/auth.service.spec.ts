...
const mockI18nService = {
  getTranslations: jest.fn().mockImplementation((key, locale, context) => {
...
describe('AuthService', () => {
  ...
  beforeEach(async () => {
    ...
    (service as any).retryWelcomeEmailLater = jest.fn().mockResolvedValue(undefined);
  });
    ...
    it('should handle email sending failure gracefully', async () => {
      ...
      expect(result).toEqual({
        ...
        warnings: expect.arrayContaining([
          expect.stringContaining('L\'email de bienvenue n\'a pas pu être envoyé'),
        ]),
      });
