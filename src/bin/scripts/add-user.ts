...
program
  ...
  .option('--isResettingPassword', 'Indique si l\'utilisateur réinitialise son mot de passe', false)
  .option('--resetPasswordToken <token>', 'Token de réinitialisation du mot de passe')
