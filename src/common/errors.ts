...
export const ERRORS = {
  ...
  DELIVERY_QR_INVALID: 'DELIVERY_QR_INVALID',
  DELIVERY_QR_EXPIRED: 'DELIVERY_QR_EXPIRED',
  DELIVERY_QR_REVOKED: 'DELIVERY_QR_REVOKED',
  DELIVERY_CHECK_NOT_FOUND: 'DELIVERY_CHECK_NOT_FOUND',
  DELIVERY_CHECK_ALREADY_COMPLETED: 'DELIVERY_CHECK_ALREADY_COMPLETED',
  DELIVERY_PRODUCT_NOT_FOUND: 'DELIVERY_PRODUCT_NOT_FOUND',
  DELIVERY_ITEMS_REQUIRED: 'DELIVERY_ITEMS_REQUIRED',
  // Payments
